...
func (broker *Broker) markDstRollbackCounter(stub shim.ChaincodeStubInterface, from string, sequenceNum string) error {
...
func (broker *Broker) markSrcRollbackCounter(stub shim.ChaincodeStubInterface, from string, sequenceNum string) error {
	idx, err := strconv.ParseUint(sequenceNum, 10, 64)
	if err != nil {
		return err
	}
