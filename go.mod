...
require (
	...
	github.com/meshplus/bitxhub-model v1.1.2-0.20210724162804-f5ed0a93a193
	github.com/meshplus/pier v1.7.1-0.20210724123830-c46aa71f71cd
...
replace (
	...
	github.com/ultramesh/crypto-gm => git.hyperchain.cn/dmlab/crypto-gm v0.2.14
